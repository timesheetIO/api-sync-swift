...
extension TimesheetSyncApi.Synchronisation {
    ...
    */
    public enum GetStateSyncData {
        ...
        public static let service = APIService<Response>(id: "getStateSyncData", tag: "Synchronisation", method: "GET", path: "/v1/sync/getStateSyncData", hasBody: false, securityRequirement: SecurityRequirement(type: "bearerAuth", scopes: []))
