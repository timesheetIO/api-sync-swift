...
extension TimesheetSyncApi.Synchronisation {
    ...
    */
    public enum PostTeamMemberSyncData {
        ...
        public static let service = APIService<Response>(id: "postTeamMemberSyncData", tag: "Synchronisation", method: "POST", path: "/v1/sync/postTeamMemberSyncData", hasBody: true)
