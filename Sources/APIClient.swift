...
public class APIClient {
    ...
    public static var `default` = APIClient(baseURL: TimesheetSyncApi.Server.main)
    ...
    public init(baseURL: String, sessionManager: SessionManager = .default, defaultHeaders: [String: String] = [:], behaviours: [RequestBehaviour] = []) {
        ...
        jsonEncoder.dateEncodingStrategy = .formatted(TimesheetSyncApi.dateEncodingFormatter)
    }
